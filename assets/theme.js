  ...
  var ProductSection = function () {
    ...
    _createClass(ProductSection, [{
      ...
      value: function _checkQuickNav() {
        ...
        fastdom.measure(function () {
          var _top = _this52.productAsideElement?_this52.productAsideElement.offsetTop:0;
          var _height = _this52.productAsideElement?_this52.productAsideElement.clientHeight:0;
          showAsideQuickNav = window.scrollY >= _top - _height;
        });
  ...
  (function () {
    ...
    (function () {
      ...
      __WEBPACK_IMPORTED_MODULE_1__helper__["DomHelper"].nodeListToArray(document.querySelectorAll('.Rte iframe')).forEach(function (iframe) {
        // We scope the wrapping only for   and Vimeo
